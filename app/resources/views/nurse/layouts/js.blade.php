...
<script>
  ...
  function myFunction1() {
    ...
    if ($("#nursing_level-1").hasClass("d-none") == false) {
    ...
    if ($("#nursing_level-2").hasClass("d-none") == false) {
    ...
    if ($("#nursing_level-3").hasClass("d-none") == false) {
    ...
    if ($("#specility_level-1").hasClass("d-none") == false) {
    ...
    if ($("#specility_level-4").hasClass("d-none") == false) {
