    ...
    <div class="col-md-12">
      <div class="box-newsletter">
        <div class="text-center">
          ...
          <p class="text-white w-75 pl-50 pr-50 mx-auto" style="opacity:0.8">Please verify your email  {{ Auth::guard('nurse_middle')->user()->email}}  address.Once verified, you'll be able to explore all the features and benefits our platform has to offer.</p>
