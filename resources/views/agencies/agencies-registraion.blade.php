      ...
      <section class="pt-30 login-register">
		  ...
		  @csrf
		     <div class="row align-items-center">
              ...
              <img src="{{ asset('nurse/assets/imgs/recruitment.png')}}" style="width: 80%;"> -->
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
              <div class="text-start">
                ...
                <h2 class="mt-10 mb-5 text-brand-1" style="line-height: 1.6em;">Recruitment Agency Registration</h2>
              </div>
              <div class="login-register text-start mt-20" action="#">
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <div class="form-group">
                  <label class="form-label" for="input-3">Agency Mobile Number *</label>
