                            ...
                            <div class="show_specialities-{{ $parts[1] }}">
                              ...
                              @foreach($stypes as $subSpecId)
                                @php
                                    ...
                                    if (
                                        isset($specialities_type['speciality_status']) &&
                                        isset($specialities_type['speciality_status']['type_'.$subSpecId])
                                    ) {
                                        $currentStatus =
                                            $specialities_type['speciality_status']['type_'.$subSpecId]->status ?? '';
                                    }
                                    ...
                                    >
                                      ...
                                      @foreach($speciality_status_data as $row)
                                        <option value="{{ $row->status_name }}"
                                          @if($row->status_name == $currentStatus) selected @endif>
                                          {{ $row->status_name }}
                                        </option>
                                      @endforeach
                                    </select>
