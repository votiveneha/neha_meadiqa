            ...
            <div class="row">
                <div class="filters col-md-4">
                    ...
                    <ul class="filter-list">
                      ...
                      <li class="filter-item" onclick="openModal('Employment Type','employeement_type_preferences','sub_prefer_id','emp_prefer_id')">
...
@section('js')
<script>
  function openModal(filter_type,table_name,column_name,main_column_id) {
    ...
    $.ajax({
      ...
      data: {filter_type:filter_type,table_name:table_name,column_name:column_name,main_column_id:main_column_id,_token:"{{ csrf_token() }}"},
      cache: false,
