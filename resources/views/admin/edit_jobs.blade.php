        ...
        <div class="card-body">
            ...
            <form method="post" id="updateJobs" onsubmit="return updateJobs()">
                ...
                <div class="form-group">
                    ...
                    <select class="js-example-basic-multiple " data-list-id="type-of-nurse" name="nurse_type[]"  id="type_nurse"></select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="location_name">
                        ...
                        <option value="{{$country_list->iso2}}" @if($country_list->iso2 == $job_list->location_name) selected @endif>{{$country_list->name }}</option>
                        @endforeach
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="agency_name">
                        ...
                        <option value="">Please Select</option>
                        @foreach ($agencies_list as $agency_show_list )
                        <option value="{{$agency_show_list->id}}" @if($agency_show_list->id == $job_list->agency_name) selected @endif>{{$agency_show_list->name }}</option>
                        @endforeach
